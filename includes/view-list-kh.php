...
function qltx_giao_dien_list_kh() {
    ...
    if (!empty($search)) {
        $results = $wpdb->get_results($wpdb->prepare(
            "SELECT * FROM $table_name WHERE ho_ten LIKE %s OR cccd LIKE %s OR so_dien_thoai LIKE %s",
    ...
    <div class="qltx-container">
        ...
        <div class="qltx-table-card">
            <table class="wp-list-table widefat fixed striped">
                <thead>
                    <tr>
                        <th width="20%">Họ tên khách hàng</th>
                        <th width="15%">Số CCCD</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <strong style="font-size: 14px; color: #2271b1;"><?php echo esc_html($row->ho_ten); ?></strong>
                        </td>
                        <td>
                            <span class="cccd-code"><?php echo esc_html($row->cccd); ?></span>
                        </td>
                        <td>
                        ...
                        <td style="color: #646970;"><?php echo esc_html($row->dia_chi); ?></td>
                        <td style="text-align: center;">
                            <span class="row-actions-visible">
                                <a href="admin.php?page=qltx-edit-kh&id=<?php echo $row->id_kh; ?>" class="btn-edit">Sửa</a> | 
